...
- 🧩 Bootstrap 5.3 (framework CSS) - Base do design e responsividade
- 🎨 CSS 3 - Estilização personalizada além do framework e ajustes de responsividade
- 🧠 JavaScript - Lógica por trás do chatbot e otimizar o código jsx da página de benefícios
- 📜 JSX — Sintaxe de extensão do JavaScript para estruturar os componentes.
